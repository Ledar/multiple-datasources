package com.ledar.db.domain.secondary;
...
public class SecUser extends AbstractAuditingEntity implements Serializable {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof SecUser)) {
            return false;
        }
        return id != null && id.equals(((SecUser) o).id);
    }
